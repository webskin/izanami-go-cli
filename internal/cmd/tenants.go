...
func init() {
	...
	adminTenantsUpdateCmd.ValidArgsFunction = completeTenantNames
	adminTenantsDeleteCmd.ValidArgsFunction = completeTenantNames
	adminTenantsLogsCmd.ValidArgsFunction = completeTenantNames
